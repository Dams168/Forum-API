...
describe('ThreadRepository', () => {
  it('should throw an error when calling unimplemented method', async () => {
    ...
    await expect(threadRepository.checkAvailabilityThread('thread-123')).rejects.toThrowError(
      'THREAD_REPOSITORY.METHOD_NOT_IMPLEMENTED',
    );

    await expect(threadRepository.getDetailThreadById('thread-123')).rejects.toThrowError(
      'THREAD_REPOSITORY.METHOD_NOT_IMPLEMENTED',
    );
  });
});
